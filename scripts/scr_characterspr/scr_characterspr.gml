function scr_characterspr()
{
	if (character == "P" && ispeppino)
	{
		...
		spr_uppercutbreak = spr_player_breakdanceuppercut
		spr_uppercutbreakend = spr_player_breakdanceuppercutend
		spr_wallcling = spr_player_clingwall
	...
	if (character == "N" or (character == "P" && (!ispeppino)))
	{
		...
		spr_exprmach3 = spr_tv_exprmach3N
		spr_exprmach3 = spr_tv_exprmach4N
	...
	if (character == "I")
	{
		spr_idle = spr_playerI_idle
		spr_move = spr_playerI_move
		spr_crawl = spr_player_crawl
		spr_idle = spr_playerI_idle
		spr_hurt = spr_player_hurt
		spr_jump = spr_playerI_jumpstart
		spr_jump2 = spr_player_jump2
		spr_fall = spr_playerI_jumpair
		spr_fall2 = spr_player_fall2
		spr_crouch = spr_player_crouch
		spr_crouchjump = spr_player_crouchjump
		spr_crouchfall = spr_player_crouchfall
		...
		spr_laddermove = spr_player_laddermove
		spr_ladderdown = spr_player_ladderdown
		spr_keyget = spr_intern_key
		spr_crouchslip = spr_player_crouchslip
		spr_pistolshot = spr_player_pistolshot
		spr_pistolwalk = spr_player_pistolwalk
		spr_mach1 = spr_playerI_mach1
		spr_mach = spr_playerI_mach2
		spr_secondjump1 = spr_playerI_mach2jump
		spr_secondjump2 = spr_playerI_mach2jumpair
		spr_machslidestart = spr_intern_tackle_stop
		spr_machslide = spr_intern_tackle_stop2
		spr_machslideend = spr_player_machslideend
		spr_machslideboost = spr_intern_tackle1_turn
		spr_land2 = spr_player_land2
		spr_punch = spr_player_punch
		spr_backkick = spr_player_backkick
		spr_shoulder = spr_player_shoulder
		...
		spr_superjumpland = spr_player_superjumpland
		spr_walljumpstart = spr_player_walljumpstart
		spr_superjumpprep = spr_playerI_sjumpprep
		spr_superjump = spr_playerI_sjump
		spr_superjumppreplight = spr_playerI_sjumpprep
		spr_superjumpright = spr_playerI_sjumpwalk
		spr_superjumpleft = spr_playerI_sjumpwalkleft
		spr_machfreefall = spr_player_machfreefall
		spr_mach3hit = spr_player_mach3hit
		spr_knightpepwalk = spr_intern_cardboardking_walk
		spr_knightpepjump = spr_intern_cardboardking_jump
		spr_knightpepfall = spr_intern_cardboardking_jump_air
		spr_knightpepidle = spr_intern_cardboardking_idle
		spr_knightpepjumpstart = spr_intern_cardboardking_jump_land
		spr_knightpepthunder = spr_knightpep_thunder
		spr_knightpepland = spr_intern_cardboardking_jump_land
		spr_knightpepdownslope = spr_intern_cardboardking_slope
		spr_knightpepstart = spr_knightpep_start
		spr_knightpepcharge = spr_intern_cardboardking_rush
		spr_bodyslamfall = spr_player_bodyslamfall
		spr_bodyslamstart = spr_player_bodyslamstart
		spr_bodyslamland = spr_player_bodyslamland
		spr_crazyrun = spr_playerI_mach4
		spr_bombpeprun = spr_bombpep_run
		spr_bombpepintro = spr_bombpep_intro
		spr_bombpeprunabouttoexplode = spr_bombpep_runabouttoexplode
		spr_bombpepend = spr_bombpep_end
		...
		spr_uppizzabox = spr_player_uppizzabox
		spr_slipnslide = spr_player_slipnslide
		spr_mach3boost = spr_intern_tackle2_turn
		spr_facehurtup = spr_player_facehurtup
		spr_facehurt = spr_player_facehurt
		spr_walljumpend = spr_player_walljumpend
		spr_suplexdash = spr_intern_grab
		...
		spr_facestomp = spr_player_facestomp
		spr_freefall = spr_player_freefall
		spr_shotgunland = spr_intern_jump_land_mayogun
		spr_shotgunshoot = spr_intern_mayogun_shot
		spr_shotgunidle = spr_intern_idle_mayogun
		spr_shotgunwalk = spr_intern_walk_mayogun
		spr_shotgunfall = spr_intern_jump_air_mayogun
		spr_shotgunjump = spr_intern_jump_mayogun
		spr_shotgunjump1 = spr_player_shotgunjump1
		spr_shotgunjump2 = spr_player_shotgunjump2
		spr_shotgunjump3 = spr_player_shotgunjump3
		spr_shotgunpullout = spr_shotgun_pullout
		spr_shotgunduck = spr_intern_crouch_idle_mayogun
		spr_shotguncrawl = spr_intern_crouch_walk_mayogun
		spr_shotgungoduck = spr_intern_crouch_walk_mayogun
		spr_fightball = spr_player_fightball
		spr_squished = spr_player_squished
		spr_supertaunt1 = spr_player_supertaunt1
		spr_supertaunt2 = spr_player_supertaunt2
		...
		spr_firemouth = spr_player_firemouth
		spr_ghostdash = spr_player_ghostdash
		spr_ghostidle = spr_intern_ghost_idle
		spr_ghostend = spr_player_ghostend
		spr_ghostjump = spr_intern_ghost_jump
		spr_mortdoublejumpstart = spr_player_mortjumpstart
		spr_mortdoublejump = spr_player_mortjump
		spr_barrelroll = spr_player_barrelroll
		spr_scaredjump1 = spr_player_scaredjump1
		...
		spr_golfidle = spr_player_golfidle
		spr_golfswing = spr_player_golfswing
		spr_cheeseballplayer = spr_intern_cheesed_roll
		spr_boxxedpepintro = spr_boxxedpep_intro
		spr_boxxedpepidle = spr_boxxedpep_idle
		spr_boxxedpepwalk = spr_boxxedpep_walk
		spr_boxxedpepair = spr_boxxedpep_air
		...
		spr_boxxedpepdashend = spr_boxxedpep_dashend
		spr_boxxedpepdash = spr_boxxedpep_dash
		spr_cheesepepintro = spr_intern_cheesed_start
		spr_cheesepepidle = spr_intern_cheesed_idle
		spr_cheesepepwalk = spr_intern_cheesed_walk
		spr_cheesepepjump = spr_intern_cheesed_jump
		spr_cheesepepjumpstart = spr_intern_cheesed_start
		spr_cheesepepfall = spr_intern_cheesed_jump_air
		spr_cheesepepland = spr_intern_cheesed_jump_land
		spr_cheesepepstickside = spr_intern_cheesed_wallclimb
		spr_cheesepepstickceiling = spr_cheesepep_stickceilling
		spr_cheesepepstickfloor = spr_cheesepep_stick
		spr_rocketstart = spr_player_rocketstart
		...
		spr_uppercutbreakend = spr_playerI_uppercutend
		spr_wallcling = spr_playerI_wallcling
		spr_longjump = spr_intern_longjump
		spr_longjumpend = spr_intern_longjump_loop
		spr_palette = spr_peppalette
		paletteselect = 1
	}
	exit;
