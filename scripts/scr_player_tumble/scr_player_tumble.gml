function scr_player_tumble()
{
	...
	if (sprite_index == spr_crouchslip && floor(image_index) == (image_number - 1))
	...
	if (sprite_index == spr_crouchslip or sprite_index == spr_breakdancesuper or sprite_index == spr_machroll or sprite_index == spr_tumble or sprite_index == spr_tumblestart or sprite_index == spr_player_machroll or sprite_index == spr_player_mach2jump)
