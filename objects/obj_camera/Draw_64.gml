...
draw_set_alpha(1)
    ...
    var _laptxt =  (string(global.laps) + (" LAPS"))
    if (global.laps > 0)
        draw_text(790, 500, _laptxt)
...
else if (obj_player1.movespeed >= 2.4 && obj_player1.movespeed < 4.8)
	draw_sprite_ext(spr_speedbar, 1, 125, 140, 1, 1, 1, c_white, alpha)
else if (obj_player1.movespeed >= 4.8 && obj_player1.movespeed < 7.2)
	draw_sprite_ext(spr_speedbar, 2, 125, 140, 1, 1, 1, c_white, alpha)
else if (obj_player1.movespeed >= 7.2 && obj_player1.movespeed < 9.6)
	draw_sprite_ext(spr_speedbar, 3, 125, 140, 1, 1, 1, c_white, alpha)
else if (obj_player1.movespeed >= 9.6 && obj_player1.movespeed < 12)
